...
export default function BlogPostPage() {
  ...
  return (
    <>
      <Head>
        <title>{post.title} | CebuAdventures Blog</title>
        <meta name="description" content={post.excerpt} />
        <meta name="keywords" content={post.keywords.join(", ")} />
        <link rel="canonical" href={`https://cebuadventures.com/blog/${post.slug}`} />
        
        <meta property="og:title" content={post.title} />
        <meta property="og:description" content={post.excerpt} />
        <meta property="og:image" content={post.image} />
        <meta property="og:url" content={`https://cebuadventures.com/blog/${post.slug}`} />
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "publisher": {
                ...
                "logo": {
                  "@type": "ImageObject",
                  "url": "https://cebuadventures.com/logo.png"
                }
              },
