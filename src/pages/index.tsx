...
export default function HomePage() {
  return (
    <>
      <Head>
        <title>CebuAdventures - Explore the Best of Cebu | Tours & Car Rentals</title>
        <meta name="description" content="Discover Cebu's pristine beaches, rich history, and unforgettable adventures. Book guided tours and car rentals with CebuAdventures - your trusted local travel partner." />
        ...
        <meta property="og:title" content="CebuAdventures - Explore the Best of Cebu" />
        ...
        <link rel="canonical" href="https://cebuadventures.com" />
      </Head>
