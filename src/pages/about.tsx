...
export default function AboutPage() {
  ...
  return (
    <>
      <Head>
        <title>About Us - Local Cebu Tour Experts | CebuAdventures</title>
        <meta name="description" content="Learn about CebuAdventures - DOT-accredited tour operator with 15+ years of experience. Meet our team of local guides passionate about sustainable tourism in Cebu, Philippines." />
        ...
        <link rel="canonical" href="https://cebuadventures.com/about" />
      </Head>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-700 mb-4">
                  CebuAdventures was born from a simple dream: to show the world the Cebu we know and love. Founded in 2010 by Maria Santos, a native Cebuano with deep roots in the island's tourism industry, we started with just two tours and a commitment to authentic, responsible travel.
                </p>
                <p className="text-lg text-gray-700 mb-4">
