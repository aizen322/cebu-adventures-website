...
export default function ContactPage() {
  ...
  return (
    <>
      <Head>
        <title>Contact Us & FAQs - Book Your Cebu Tour | CebuAdventures</title>
        <meta name="description" content="Contact CebuAdventures for tour bookings, inquiries, and customer support. Find answers to common questions about our Cebu tours, bookings, and policies." />
        ...
        <link rel="canonical" href="https://cebuadventures.com/contact" />
      </Head>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">info@cebuadventures.com</p>
                        <p className="text-sm text-gray-600">bookings@cebuadventures.com</p>
                      </div>
                    </div>
              ...
              <CardContent>
                <div className="aspect-video rounded-lg overflow-hidden">
                  <iframe
                    ...
                    title="CebuAdventures Office Location"
                  />
                </div>
              </CardContent>
            </Card>
